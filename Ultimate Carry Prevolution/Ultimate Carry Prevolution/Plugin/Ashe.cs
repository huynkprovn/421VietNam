...
namespace Ultimate_Carry_Prevolution.Plugin
{
	class Ashe:Champion
	{
		...
		private void Cast_R(int mode)
		{
			...
			var targetMode1 = LeagueSharp.Common.TargetSelector.GetTarget(W.Range, LeagueSharp.Common.TargetSelector.DamageType.Physical);
			var targetMode2 = LeagueSharp.Common.TargetSelector.GetTarget(R.Range, LeagueSharp.Common.TargetSelector.DamageType.Physical);
			switch (mode)
			{
				case 1:
					if (targetMode1 == null)
