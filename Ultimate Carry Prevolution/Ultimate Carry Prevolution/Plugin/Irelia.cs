...
namespace Ultimate_Carry_Prevolution.Plugin
{
    class Irelia : Champion
    {
        ...
        public override void OnCombo()
        {
            ...
            var Q_Target = LeagueSharp.Common.TargetSelector.GetTarget(Q.Range, LeagueSharp.Common.TargetSelector.DamageType.Physical);
            if (Q_Target != null)
            {
        ...
        {
            var target = LeagueSharp.Common.TargetSelector.GetTarget(Q.Range * 2, LeagueSharp.Common.TargetSelector.DamageType.Physical);
        ...
        private void Cast_W()
        {
            var target = LeagueSharp.Common.TargetSelector.GetTarget(200, LeagueSharp.Common.TargetSelector.DamageType.Physical);
        ...
        private void Cast_R()
        {
            var target = LeagueSharp.Common.TargetSelector.GetTarget(MyHero.Spellbook.GetSpell(SpellSlot.R).ToggleState == 1 ? Q.Range : R.Range,
