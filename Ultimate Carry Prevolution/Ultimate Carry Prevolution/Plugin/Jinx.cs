...
namespace Ultimate_Carry_Prevolution.Plugin
{
    class Jinx : Champion
    {
		...
		{
            var W_Target = LeagueSharp.Common.TargetSelector.GetTarget(1500, LeagueSharp.Common.TargetSelector.DamageType.Physical);
        ...
        private void Q_Check()
        {
            ...
            var target = LeagueSharp.Common.TargetSelector.GetTarget(Q_Range, LeagueSharp.Common.TargetSelector.DamageType.Physical);
