...
namespace Ultimate_Carry_Prevolution.Plugin
{
	class Azir : Champion
	{
		...
		public override void OnPassive()
		{
			...
			{
				var soilderTarget = LeagueSharp.Common.TargetSelector.GetTarget(900, LeagueSharp.Common.TargetSelector.DamageType.Magical);
		...
		{
			var target = LeagueSharp.Common.TargetSelector.GetTarget(_qExtend.Range, LeagueSharp.Common.TargetSelector.DamageType.Magical);
			var soilderTarget = LeagueSharp.Common.TargetSelector.GetTarget(1000, LeagueSharp.Common.TargetSelector.DamageType.Magical);
		...
		private void Misc_Insec()
		{
			...
			if(LeagueSharp.Common.TargetSelector.GetSelectedTarget() != null)
                target = LeagueSharp.Common.TargetSelector.GetSelectedTarget();
		...
		private void Auto_Attack_Enemy()
		{
			...
			var soilderTarget = LeagueSharp.Common.TargetSelector.GetTarget(800, LeagueSharp.Common.TargetSelector.DamageType.Magical);
